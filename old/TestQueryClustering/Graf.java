...
public class Graf {
    ...
    public Graf(Map<Integer,Entitat> entitats, ArrayList<ArrayList<String>> relacions) { //Para cargarlo desde fichero
        ...
        System.out.println("La carrega desde fitxer ha finalitzat amb "+errors+" errors");
    }
