...
public class VistaSeleccionarCami extends JDialog{
	...
	private void init_table() {
		getContentPane().setLayout(new MigLayout("", "[438px]", "[25px][229px]"));
		table = new JTable(caminsData);
		table.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		JScrollPane scrollPane = new JScrollPane(table);
		getContentPane().add(scrollPane, "cell 0 1,growx,aligny center");
	}
	...
	private void init_Seleccionar() {
		...
		getContentPane().add(btnSeleccionar, "cell 0 0,alignx right,aligny top");
	}
